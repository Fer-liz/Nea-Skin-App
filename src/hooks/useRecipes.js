...
export const useRecipes = () => {
    ...
    const updateRecipe = async (id, nombre, gramaje, margen, ingredientes, extras, notas = '') => {
        try {
            ...
            // Note: In a real transaction we'd do this safer, but Supabase JS client doesn't support transactions easily yet without RPC.
            // Deleting by FK cascade would be ideal in SQL, but manually here:
